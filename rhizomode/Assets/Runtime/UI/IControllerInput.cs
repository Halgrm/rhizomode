...
namespace Rhizomode.UI
{
    ...
    {
        /// <summary>ノード生成メニュー呼び出し（Left X performed）。</summary>
        Observable<Unit> OnOpenMenu { get; }

        /// <summary>メニュー展開ホールド（Left X press/release）。</summary>
        Observable<bool> OnMenuHold { get; }

        /// <summary>メニュー閉じ（Left Y）。</summary>
        Observable<Unit> OnCloseMenu { get; }
