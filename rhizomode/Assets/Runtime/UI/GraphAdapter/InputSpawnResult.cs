...
namespace Rhizomode.UI
{
    ...
    /// (各 position) を一緒に運ぶ DTO。<c>Rhizomode.Interaction.NodeSpawnService</c> が生成し、
    ...
    /// 持ち上げ、MenuNodeSpawnCoordinator (UI.GraphAdapter) と NodeSpawnService (Interaction、
    /// Phase D で移送) を同一 DTO 経由で結ぶことで MenuNodeSpawnCoordinator の NodeSpawnService
    /// 直接依存を解消する。
    /// </remarks>
